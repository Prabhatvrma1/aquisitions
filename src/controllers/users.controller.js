...
import { getAllUsers, getUserById as getUserService, updateUser as updateUserService, deleteUser as deleteUserService } from '../services/users.service.js';
...
export const updateUser = async (req, res, next) => {
    try {
        ...
        if (updates.role && currentUser.role !== 'admin') {
            logger.warn(`User ${currentUser.id} attempted to change role to ${updates.role}`);
        ...
        if (e.message.includes('unique constraint')) { // For duplicate email
